...
Project done during **Software Engineering** course at **ALX School**. 
...
| `tests/6-max_integer_test.py` | Unittests for the function `def max_integer(list=[])` |# Test-driven development
