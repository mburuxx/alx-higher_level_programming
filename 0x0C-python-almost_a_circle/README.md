# Almost a circle
Project done during **Full Stack Software Engineering studies** at **ALX Africa**. It aims to teach about unit testing, serialization, deserialization, JSON, `args` and `kwargs` in **Python**.
